...
public class CommandTestUtil {
    ...
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS + "Street&"; // '&' not allowed in addresses
    public static final String INVALID_INFO_DESC = " " + PREFIX_INFO + "apples&"; // '&' not allowed in information
