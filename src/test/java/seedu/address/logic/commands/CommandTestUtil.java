...
public class CommandTestUtil {
    ...
    public static final String VALID_INFO_AMY = "none";
    public static final String VALID_INFO_BOB = "none";
    public static final String VALID_PRICE_AMY = "0.00";
    ...
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS + "123 Street&"; // '&' not allowed in addresses
    public static final String INVALID_INFO_DESC = " " + PREFIX_INFO + "apples & oranges"; // '&' not allowed in information
    public static final String INVALID_PRICE_DESC = " " + PREFIX_PRICE + "8uh"; // 'uh' not allowed in prices
